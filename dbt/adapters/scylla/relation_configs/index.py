...
class ScyllaIndexMethod(StrEnum):
    none = ""
    keys = "keys"
    entries = "entries"
    full = "full"
    ...
    @classmethod
    def default(cls) -> "ScyllaIndexMethod":
        return cls.none


@dataclass(frozen=True, eq=True, unsafe_hash=True)
class ScyllaIndexConfig(RelationConfigBase, RelationConfigValidationMixin):
    """
    ...
    method: ScyllaIndexMethod = field(default=ScyllaIndexMethod.default(), hash=True)
    ...
    @classmethod
    def from_dict(cls, config_dict) -> "ScyllaIndexConfig":
        ...
        index: "ScyllaIndexConfig" = super().from_dict(kwargs_dict)  # type: ignore
        return index
...
@dataclass(frozen=True, eq=True, unsafe_hash=True)
class ScyllaIndexConfigChange(RelationConfigChange, RelationConfigValidationMixin):
    """
